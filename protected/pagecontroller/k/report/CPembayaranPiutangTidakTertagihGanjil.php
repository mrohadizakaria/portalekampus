...
class CPembayaranPiutangTidakTertagihGanjil extends MainPageK {
	public function onLoad($param) {		
		parent::onLoad($param);						
        $this->showReport=true;
        $this->showPembayaranPiutangTidakTertagihGanjil=true;                
        $this->createObj('Finance');
		if (!$this->IsPostBack&&!$this->IsCallBack) {	
            if (!isset($_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil'])||$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['page_name']!='k.report.PembayaranPiutangTidakTertagihGanjil') {
				$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']=array('page_name'=>'k.report.PembayaranPiutangTidakTertagihGanjil','page_num'=>0,'search'=>false,'kelas'=>'none','tahun_masuk'=>$_SESSION['tahun_masuk']);												
			}
            $_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['search']=false;                       
			...
			$this->tbCmbTahunMasuk->Text=$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['tahun_masuk'];						
			$this->tbCmbTahunMasuk->dataBind();
            
            $kelas=$this->DMaster->getListKelas();
            $kelas['none']='All';
			$this->tbCmbKelas->DataSource=$kelas;
			$this->tbCmbKelas->Text=$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['kelas'];			
    ...
    public function setInfoToolbar() {        
        ...
        $tahun_masuk=$this->DMaster->getNamaTA($_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['tahun_masuk']);	
	...
	public function changeTbTahunMasuk($sender,$param) {    				
		$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['tahun_masuk']=$this->tbCmbTahunMasuk->Text;		        
		$this->setInfoToolbar(); 
        $this->populateData();
	}
    public function changeTbTA ($sender,$param) {				
		$_SESSION['ta']=$this->tbCmbTA->Text;		        
		$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['tahun_masuk']=$_SESSION['ta'];
	...
	public function changeTbKelas ($sender,$param) {				
		$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['kelas']=$this->tbCmbKelas->Text;
        $this->setInfoToolbar(); 
		$this->populateData();
	}    
    public function changeTbStatus ($sender,$param) {				
		$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['currentPagePembayaranPiutangTidakTertagihGanjil']['k_status']=$this->tbCmbStatus->Text;		        
		$this->populateData();
	}
	...
	public function Page_Changed ($sender,$param) {
		$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['page_num']=$param->NewPageIndex;
		$this->populateData($_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['search']);
	}    
    public function searchRecord ($sender,$param) {
		$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['search']=true;
        $this->populateData($_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['search']);
	}    
	public function populateData ($search=false) {			
        $kjur=$_SESSION['kjur'];  
        $ta=$_SESSION['ta'];                    
        $tahun_masuk=$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['tahun_masuk'];                    
             
        $kelas=$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['kelas'];
        ...
        $this->RepeaterS->CurrentPageIndex=$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['page_num'];
		...
		if ($limit < 0) {$offset=0;$limit=6;$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['page_num']=0;}
    ...
    public function printOut ($sender,$param) {	
        ...
        switch ($_SESSION['outputreport']) {
            ...
            case  'excel2007' :
                ...
                $dataReport['kelas']=$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjil']['kelas'];
                $dataReport['linkoutput']=$this->linkOutput;
                $this->report->setDataReport($dataReport); 
                $this->report->setMode($_SESSION['outputreport']);
                
                $this->report->printPembayaranPiutangTidakTertagihGanjil($this->Finance,$this->DMaster); 
            break;
            case  'pdf' :
