...
class CPembayaranPiutangTidakTertagihGanjilDulang extends MainPageK {
	public function onLoad($param) {		
		parent::onLoad($param);						
        $this->showReport=true;
        $this->showPembayaranPiutangTidakTertagihGanjilDulang=true;                
        $this->createObj('Finance');
		if (!$this->IsPostBack&&!$this->IsCallBack) {	
            if (!isset($_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang'])||$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['page_name']!='k.report.PembayaranPiutangTidakTertagihGanjilDulang') {
				$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']=array('page_name'=>'k.report.PembayaranPiutangTidakTertagihGanjilDulang','page_num'=>0,'search'=>false,'kelas'=>'none','tahun_masuk'=>$_SESSION['tahun_masuk']);												
			}
            $_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['search']=false;                       
			...
			$this->tbCmbTahunMasuk->Text=$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['tahun_masuk'];						
			$this->tbCmbTahunMasuk->dataBind();
            
            $kelas=$this->DMaster->getListKelas();
            $kelas['none']='All';
			$this->tbCmbKelas->DataSource=$kelas;
			$this->tbCmbKelas->Text=$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['kelas'];			
    ...
    public function setInfoToolbar() {        
        ...
        $tahun_masuk=$this->DMaster->getNamaTA($_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['tahun_masuk']);	
	...
	public function changeTbTahunMasuk($sender,$param) {    				
		$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['tahun_masuk']=$this->tbCmbTahunMasuk->Text;		        
		$this->setInfoToolbar(); 
        $this->populateData();
	}
    public function changeTbTA ($sender,$param) {				
		$_SESSION['ta']=$this->tbCmbTA->Text;		        
		$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['tahun_masuk']=$_SESSION['ta'];
	...
	public function changeTbKelas ($sender,$param) {				
		$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['kelas']=$this->tbCmbKelas->Text;
        $this->setInfoToolbar(); 
		$this->populateData();
	}    
    public function changeTbStatus ($sender,$param) {				
		$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['k_status']=$this->tbCmbStatus->Text;		        
		$this->populateData();
	}
	...
	public function Page_Changed ($sender,$param) {
		$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['page_num']=$param->NewPageIndex;
		$this->populateData($_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['search']);
	}    
    public function searchRecord ($sender,$param) {
		$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['search']=true;
        $this->populateData($_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['search']);
	}    
	public function populateData ($search=false) {			
        $kjur=$_SESSION['kjur'];  
        $ta=$_SESSION['ta'];                    
        $tahun_masuk=$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['tahun_masuk'];                    
             
        $kelas=$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['kelas'];
        ...
        $str = "SELECT no_formulir,nim,nirm,nama_mhs,jk,idkelas,tahun_masuk,semester_masuk FROM v_datamhs vdm, dulang d WHERE vdm.kjur='$kjur'AND vdm.tahun_masuk=$tahun_masuk AND k_status!='L' $str_kelas";			
        $this->RepeaterS->CurrentPageIndex=$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['page_num'];
		...
		if ($limit < 0) {$offset=0;$limit=6;$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['page_num']=0;}
    ...
    public function printOut ($sender,$param) {	
        ...
        switch ($_SESSION['outputreport']) {
            ...
            case  'excel2007' :
                ...
                $dataReport['kelas']=$_SESSION['currentPagePembayaranPiutangTidakTertagihGanjilDulang']['kelas'];
                $dataReport['linkoutput']=$this->linkOutput;
                $this->report->setDataReport($dataReport); 
                $this->report->setMode($_SESSION['outputreport']);
                
                $this->report->printPembayaranPiutangTidakTertagihGanjilDulang($this->Finance,$this->DMaster); 
            break;
            case  'pdf' :
